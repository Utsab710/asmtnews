        ...
        <?php
          if(mysqli_num_rows($categoryResult)==0){
           ...
           <tr>            
             ...
             <td> <a href="db/delete-category.php?id=<?php echo $row['id'];?>"><i class="fa-solid fa-trash"></i> </a>| E</td>
           </tr>
           <?php } ?>
             </tbody>
             </table>
...
<script src="https://kit.fontawesome.com/8592ee0906.js" crossorigin="anonymous"></script>
</body>
</html>